...
#ifndef __STM32U5XX_NUCLEO_H
#define __STM32U5XX_NUCLEO_H
...
/** @defgroup STM32U5XX_NUCLEO
 * @{
 */

/** @defgroup STM32U5XX_NUCLEO_LOW_LEVEL
 * @{
 */
 ...
 */
#define __STM32U5XX_NUCLEO_BSP_VERSION_MAIN   (uint32_t)(0x01) /*!< [31:24] main version */
#define __STM32U5XX_NUCLEO_BSP_VERSION_SUB1   (uint32_t)(0x00) /*!< [23:16] sub1 version */
#define __STM32U5XX_NUCLEO_BSP_VERSION_SUB2   (uint32_t)(0x00) /*!< [15:8]  sub2 version */
#define __STM32U5XX_NUCLEO_BSP_VERSION_RC     (uint32_t)(0x00) /*!< [7:0]  release candidate */
#define __STM32U5XX_NUCLEO_BSP_VERSION        ((__STM32U5XX_NUCLEO_BSP_VERSION_MAIN << 24)\
                                                    |(__STM32U5XX_NUCLEO_BSP_VERSION_SUB1 << 16)\
                                                    |(__STM32U5XX_NUCLEO_BSP_VERSION_SUB2 << 8 )\
                                                    |(__STM32U5XX_NUCLEO_BSP_VERSION_RC))

/** @defgroup STM32U5XX_NUCLEO_LOW_LEVEL_Exported_Types STM32U5XX_NUCLEO LOW LEVEL Exported Types
 * @{
 */
...
/** @defgroup STM32U5XX_NUCLEO_LOW_LEVEL_LED STM32U5XX_NUCLEO LOW LEVEL LED
 * @{
 */
...
#define BUS_BSP_LED_GPIO_PIN GPIO_PIN_7

/**
 * @}
 */

/** @defgroup STM32U5XX_NUCLEO_LOW_LEVEL_BUTTON STM32U5XX_NUCLEO LOW LEVEL BUTTON
 * @{
 */
/* Button state */
 ...
 * @}
 */
/** @defgroup STM32U5XX_NUCLEO_LOW_LEVEL_COM STM32U5XX_NUCLEO LOW LEVEL COM
 * @{
 */
/**
...
/** @defgroup STM32U5XX_NUCLEO_LOW_LEVEL_Exported_Functions STM32U5XX_NUCLEO LOW LEVEL Exported Functions
 * @{
 */
