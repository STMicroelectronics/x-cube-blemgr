...
#ifndef __STEVAL_MKBOXPRO_H
#define __STEVAL_MKBOXPRO_H
...
/** @defgroup STEVAL_MKBOXPRO
 * @{
 */

/** @defgroup STEVAL_MKBOXPRO_LOW_LEVEL
 * @{
 */
 ...
 */
#define __STEVAL_MKBOXPRO_BSP_VERSION_MAIN   (uint32_t)(0x01) /*!< [31:24] main version */
#define __STEVAL_MKBOXPRO_BSP_VERSION_SUB1   (uint32_t)(0x00) /*!< [23:16] sub1 version */
#define __STEVAL_MKBOXPRO_BSP_VERSION_SUB2   (uint32_t)(0x00) /*!< [15:8]  sub2 version */
#define __STEVAL_MKBOXPRO_BSP_VERSION_RC     (uint32_t)(0x00) /*!< [7:0]  release candidate */
#define __STEVAL_MKBOXPRO_BSP_VERSION        ((__STEVAL_MKBOXPRO_BSP_VERSION_MAIN << 24)\
                                                    |(__STEVAL_MKBOXPRO_BSP_VERSION_SUB1 << 16)\
                                                    |(__STEVAL_MKBOXPRO_BSP_VERSION_SUB2 << 8 )\
                                                    |(__STEVAL_MKBOXPRO_BSP_VERSION_RC))

/** @defgroup STEVAL_MKBOXPRO_LOW_LEVEL_Exported_Types STEVAL_MKBOXPRO LOW LEVEL Exported Types
 * @{
 */

 /**
  * @brief Define for STEVAL_MKBOXPRO board
  */
#if !defined (USE_STEVAL_MKBOXPRO)
 #define USE_STEVAL_MKBOXPRO
#endif
#ifndef USE_BSP_COM_FEATURE
   #define USE_BSP_COM_FEATURE                  0U
#endif

/** @defgroup STEVAL_MKBOXPRO_LOW_LEVEL_LED STEVAL_MKBOXPRO LOW LEVEL LED
 * @{
 */
...
#define BUS_BSP_LED_GPIO_CLK_ENABLE() __HAL_RCC_GPIOF_CLK_ENABLE()
#define BUS_BSP_LED_GPIO_PORT GPIOF
#define BUS_BSP_LED_GPIO_CLK_DISABLE() __HAL_RCC_GPIOF_CLK_DISABLE()
...
/** @defgroup STEVAL_MKBOXPRO_LOW_LEVEL_BUTTON STEVAL_MKBOXPRO LOW LEVEL BUTTON
 * @{
 */
/* Button state */
 ...
 * @}
 */
/** @defgroup STEVAL_MKBOXPRO_LOW_LEVEL_COM STEVAL_MKBOXPRO LOW LEVEL COM
 * @{
 */
/**
...
/** @defgroup STEVAL_MKBOXPRO_LOW_LEVEL_Exported_Types LOW LEVEL Exported Types
  * @{
  */
#ifndef USE_BSP_COM
...
/** @defgroup STEVAL_MKBOXPRO_LOW_LEVEL_Exported_Functions STEVAL_MKBOXPRO LOW LEVEL Exported Functions
 * @{
 */
