...
#ifndef STEVAL_MKBOXPRO_CONF_H
#define STEVAL_MKBOXPRO_CONF_H
...
/** @defgroup STEVAL_MKBOXPRO_CONFIG Config
  * @{
  */

/** @defgroup STEVAL_MKBOXPRO_CONFIG_Exported_Constants
  * @{
  */
/* COM Feature define */
