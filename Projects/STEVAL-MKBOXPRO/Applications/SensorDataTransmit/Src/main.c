...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(USB_ENUM_LED_GPIO_Port, USB_ENUM_LED_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : USB_ENUM_LED_Pin */
  GPIO_InitStruct.Pin = USB_ENUM_LED_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(USB_ENUM_LED_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : BUTTON_PWR_Pin SD_DETECT_Pin */
  GPIO_InitStruct.Pin = BUTTON_PWR_Pin|SD_DETECT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);
