...
/** @defgroup STEVAL_MKBOXPRO STEVAL_MKBOXPRO
 * @{
 */

/** @defgroup STEVAL_MKBOXPRO_LOW_LEVEL STEVAL_MKBOXPRO LOW LEVEL
...
/** @defgroup STEVAL_MKBOXPRO_LOW_LEVEL_Private_Defines STEVAL_MKBOXPRO LOW LEVEL Private Defines
 * @{
 */

/** @defgroup STEVAL_MKBOXPRO_LOW_LEVEL_FunctionPrototypes STEVAL_MKBOXPRO LOW LEVEL Private Function Prototypes
 * @{
 */
...
/** @defgroup STEVAL_MKBOXPRO_LOW_LEVEL_Private_Variables STEVAL_MKBOXPRO LOW LEVEL Private Variables
 * @{
 */
...
{
  return (int32_t)__STEVAL_MKBOXPRO_BSP_VERSION;
}
